      ...
      Webflow.define(
        ...
        (module.exports = function ($) {
          ...
          function createBadge() {
            ...
            var $logoText = $("<img>").attr("src", "p").attr("alt", "");
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "5fe5db23aba8db3555d01bfd|c2901747-56d4-9553-6268-88eb341c98e1",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
      ...
      createdOn: 1602806236695,
    },
  },
  actionLists: {
    a: {
      id: "a",
      title: "side card disappear",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".side-card",
                  selectorGuids: ["39e70b9f-d57b-2c25-b5b0-498126cff3c9"],
                },
                value: 0,
                unit: "",
              },
